...
class App(tk.Tk):
    ...
    def __init__(self):
        ...
        self.iconbitmap('./password_generator/icons/key.ico')
        self.size(300,200)
        self.main_screen()
    ...
    def main_screen(self):
        ...
        self.begin_image = tk.PhotoImage(file='./password_generator/images/lock.png')
        self.quit_image = tk.PhotoImage(file='./password_generator/images/exit.png')
